...
export default function Post({ data, id }: PostProps) {
  ...
  async function likePost() {
    ...
    if (data.likes.includes(user.uid)) {
      ...
      await updateDoc(postRef, {
        // if not liked and heart icon is pressed, like
    ...
    <div className="flex p-3 space-x-5">
      ...
      <div className="text-[15px] flex flex-col space-y-1.5">
        <div className="flex space-x-1.5  text-[#707E89">
          <span className="font-bold text-[#0F1419] whitespace-nowrap overflow-hidden text-ellipsis inline-block max-w-[60px] min-[400px]:max-w-[100px] min-[500px]:max-w-[140px] sm:max-w-[160px]">
            {name}
          </span>
          <span className="whitespace-nowrap overflow-hidden text-ellipsis inline-block max-w-[60px] min-[400px]:max-w-[100px] min-[500px]:max-w-[140px] sm:max-w-[160px]">
            @{username}
          </span>
          {timestamp && (
            <>
