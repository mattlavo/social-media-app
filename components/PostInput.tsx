    ...
    <div className="flex space-x-5 p-3 border-b border-gray-100">
      ...
      <div className="w-full">
        ...
        <div className="flex justify-between pt-5 border-t border-gray-100">
          ...
          <button disabled={!text} onClick={() => insideModal ? sendComment() : sendPost()} className="bg-[#F4AF01] text-white w-[80px] h-[36px] rounded-full text-sm cursor-pointer disabled:bg-opacity-60">
            Bumble
          </button>
        </div>
      </div>
